...
#define STRING_CONFIG_H_AUTHOR "(Makoto Schoppert, Robo3D R1+)" // Who made the changes.
...
#define TEMP_SENSOR_BED 0 // ncrmro
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  //M301 P19.16 I0.87 D105.16
    #define DEFAULT_Kp 19.16
    #define DEFAULT_Ki 0.87
    #define DEFAULT_Kd 105.16
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 30.55
  #define DEFAULT_bedKi 4.97
  #define DEFAULT_bedKd 125.11
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 723.38 } // ncrmro
// Robo without jumpers causes DRV8825 to be at 1/32 microstepping
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 815 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 1.20 }
